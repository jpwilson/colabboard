...
- Strengths: frame at (100, 100) 350x300 fill=#dcfce7, title "Strengths"
- Weaknesses: frame at (470, 100) 350x300 fill=#fecaca, title "Weaknesses"
- Opportunities: frame at (100, 420) 350x300 fill=#bfdbfe, title "Opportunities"
- Threats: frame at (470, 420) 350x300 fill=#fef08a, title "Threats"

**Retrospective** (3 columns):
- What went well: frame at (100, 100) 300x400 fill=#dcfce7, title "Went Well"
- What to improve: frame at (420, 100) 300x400 fill=#fecaca, title "To Improve"
- Action items: frame at (740, 100) 300x400 fill=#bfdbfe, title "Actions"

**Kanban Board** (3-4 columns):
- To Do: frame at (100, 100) 250x500 fill=#f1f5f9, title "To Do"
- In Progress: frame at (370, 100) 250x500 fill=#fef08a, title "In Progress"
- Done: frame at (640, 100) 250x500 fill=#dcfce7, title "Done"

**Pros and Cons** (2 columns):
- Pros: frame at (100, 100) 350x400 fill=#dcfce7, title "Pros"
- Cons: frame at (470, 100) 350x400 fill=#fecaca, title "Cons"
...
- Start: rounded_rectangle at (300, 100) 150x60 fill=#dcfce7, text "Start"
- Process: rectangle at (275, 220) 200x80 fill=#bfdbfe, text "Process"
- Decision: diamond at (300, 360) 150x120 fill=#fef08a, text "Decision?"
- End: rounded_rectangle at (300, 540) 150x60 fill=#fecaca, text "End"
...
- High Impact / Low Effort: frame at (100, 100) 350x300 fill=#dcfce7, title "Do First"
- High Impact / High Effort: frame at (470, 100) 350x300 fill=#bfdbfe, title "Schedule"
- Low Impact / Low Effort: frame at (100, 420) 350x300 fill=#fef08a, title "Delegate"
- Low Impact / High Effort: frame at (470, 420) 350x300 fill=#fecaca, title "Eliminate"
